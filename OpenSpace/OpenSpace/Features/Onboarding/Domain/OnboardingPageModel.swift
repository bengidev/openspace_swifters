...
struct OnboardingPageModel: Equatable, Sendable {
    ...
    // Explicit `nonisolated` init so the `nonisolated static let all = [...]`
    // literal below can construct values from a non-main-actor context under
    // Swift 6 strict concurrency. SwiftLint flags this as a memberwise
    // duplicate; the isolation annotation is the reason it stays.
...
private extension OnboardingPageModel {
    nonisolated static let encryptedPairing = OnboardingPageModel(
        ...
        body: """
        Pair trusted devices, keep local workspace context private, and \
        open AI chats without leaking the conversation boundary.
        """,
        metric: "E2E CHANNEL",
        command: "pair --device workspace --mode sealed",
        shaderIntensity: 0.78,
        highlights: [
            OnboardingFeatureHighlightModel(
                title: "Local memory",
    ...
    nonisolated static let ideaStudio = OnboardingPageModel(
        id: "idea-studio",
        type: .ideaStudio,
        indexLabel: "AI-02",
        ...
        body: """
        OpenSpace turns prompts into a focused working surface for drafting, \
        refactoring, research, and interface decisions.
        """,
        metric: "MODEL STUDIO",
    ...
    nonisolated static let promptQueue = OnboardingPageModel(
        id: "prompt-queue",
        type: .promptQueue,
        indexLabel: "RUN-03",
        ...
        body: """
        Keep momentum by lining up the next question, test request, or \
        implementation step before the current model turn finishes.
        """,
        metric: "LIVE QUEUE",
    ...
    nonisolated static let reasoningControl = OnboardingPageModel(
        ...
        body: """
        Choose faster answers, balanced planning, or deeper reasoning before \
        the AI model commits compute to the task.
        """,
        metric: "THINK BUDGET",
    ...
    nonisolated static let workspaceReady = OnboardingPageModel(
        id: "workspace-ready",
        type: .workspaceReady,
        indexLabel: "RDY-05",
        ...
        headline: "OpenSpace",
        body: """
        Your AI-native command center. Deploy specialized agents to handle \
        code, review, test, and ship — all within your existing workflow \
